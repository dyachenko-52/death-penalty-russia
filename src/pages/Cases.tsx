...
const cases: CriminalCase[] = [
  ...
  },
  {
    ...
    details: "Дмитрий Ковалёв был осуждён в 1990-х годах за убийство и приговорён к смертной казни. Его случай стал известен после того, как позже выяснилось, что он не совершал инкриминируемого ему преступления. К сожалению, это было установлено уже после того, как приговор был приведён в исполнение. Дело Ковалёва стало одним из самых ярких символов необратимости судебных ошибок при применении смертной казни и важным аргументом для противников высшей меры наказания.",
